...
<tr>
<td colspan="2">
<s:if test="#canSendUsers.size()<1">没有可发送的部门</s:if>
<s:else><s:checkboxlist theme="simple" list="#canSendUsers" listKey="id" listValue="nickname" name="sendUserIds"/></s:else>
</td>
</tr>
<tr>
<td colspan="2">
...
<tr>
<td colspan="2">
<textarea rows="20" cols="100" class="xheditor" name="contend"></textarea>
</td>
</tr>
